...
public class Driver_Mechanum extends OpMode {
    ...
    public void backEncoderDrive(double speed, double bLeftInches, double bRightInches,
                             double timeoutS) throws InterruptedException {
        int newbLeftTarget;
        int newbRightTarget;
        ...
        if (opModeIsActive) {
            ...
            while (opModeIsActive &&
                ...
                // Display it for the driver.
                telemetry.addData("Path1",  "Running to %7d :%7d", newbLeftTarget,  newbRightTarget);
                telemetry.addData("Path2",  "Running at %7d :%7d",
